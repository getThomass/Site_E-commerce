	 			...
	 			<div class="collapse navbar-collapse" id="main-navigation">
	 				<ul class="navbar-nav">
	 					<li class="deroulant"><a class="nav-link"href="#">Categorie</a>
	 						...
	 						<ul class="deroule">
	 							<li><a href="#">Trésor ou Ferraille</a></li>
	 							<li><a href="#">Bon pour le musée</a></li>
	 							<li><a href="#">Accesoire VIP</a></li>
	 						</ul>


	 					</li>
	 					<li class="nav-item"><a class="nav-link"href="menuacheteur.php?email=<?php echo $_GET["email"];?>">Achat</a></li>
	 	...
	 	<header class="page-header header container-fluid">
			...
			{$('.header').height($(window).height());});
	 		...
	 		<div class="description">
                ...
                <button><a href="#"><span class="affichage">Let's go !</span></a></button>
