...
{?>
        <div class="col-md-12">
            <form action="verifieenchere.php?article=<?php echo $article; ?>&amp;email=<?php echo $email; ?>" method="post" >
                ...
                <center><p>Date de fin de l'annonce : <?php echo $donnees['Date_fin']; ?></p></center>
                
                
                <center> <h3> Quelle est votre prix maximal pour cette echère : </h3><input type="text" name="propositionenchere" />€<br>
                
                <input type="submit" value="Valider mon enchere" /></a>
                </center>
